...
Extract `mobilelab-kit-0.6.0.tar.gz` from the v0.6 GitHub Release and add that directory as a local Swift Package, then configure a URL reachable by the Simulator or device:
