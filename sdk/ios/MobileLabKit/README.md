...
Extract `mobilelab-kit-0.5.0.tar.gz` from the v0.5 GitHub Release and add that directory as a local Swift Package, then configure a URL reachable by the Simulator or device:
